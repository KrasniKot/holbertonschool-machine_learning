...
class WGAN_GP(keras.Model):
    ...
    def __init__(self, generator, discriminator, latent_generator,
        ...
        """ Initializes a WGAN with Gradient Penalty
            ...
            - lambda_gp = determines the strength of the gradient penalty
            """
    ...
    def replace_weights(self, gen_h5, disc_h5):
        """ Replace the weights for generator and discriminator
            ...
            - gen_h5: file path where weights for generator are stored
            - disc_h5: file path where weights for discriminator are stored
        """
