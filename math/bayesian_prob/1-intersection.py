#!/usr/bin/env python3
""" This module contains interesection() that calculates the intersection
    of obtaining this data with the various hypothetical probabilities
"""
